...
async function getStaticProps() {
  // fetch data from API
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://onare:WiMsduI0Ilhoc0GT@cluster0.ng3yd.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
